...
import tdh.quanlytoanha.dao.CompanyEmployeeDAO;
import tdh.quanlytoanha.dtos.CompanyEmployeeDTO;
import tdh.quanlytoanha.service.company_employee.ICompanyEmployeeService;
...
public class CompanyEmployeeController {
    ...
    public ResponseEntity<List<CompanyEmployeeDTO>> findAllEmployeeOfCompany(@PathVariable Integer companyId) {
        return new ResponseEntity<>(companyEmployeeService.findAllEmployeeOfCompany(companyId), HttpStatus.OK);
    }
